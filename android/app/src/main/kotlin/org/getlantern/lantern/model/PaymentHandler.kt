...
class PaymentHandler(private val activity: Activity) {
    ...
    public fun submitStripe(email: String, cardNumber: String, expirationDate: String, 
            ...
            stripe.createCardToken(
                ...
                callback = object : ApiResultCallback<Token> {
                    override fun onSuccess(@NonNull token: Token) {
                        ...
                        sendPurchaseRequest(email, "stripe", methodCallResult)
                    }
    ...
    private fun sendPurchaseRequest(email: String, provider: String, methodCallResult: MethodChannel.Result) {
    ...
    companion object {
        private val TAG = PaymentHandler::class.java.name
