...
class PaymentsUtil(private val activity: Activity) {
    ...
    public fun submitStripePayment(email: String, cardNumber: String, expirationDate: String, 
    ...
    fun submitBitcoinPayment(planID: String, email: String, refCode:String, methodCallResult: MethodChannel.Result) {
        try {
            ...
            lanternClient.post(LanternHttpClient.createProUrl("/payment-redirect", params), formBody,
                object : ProCallback {
