    ...
    builder: (BuildContext context) {
      ...
      return StatefulBuilder(
        builder: (statefulContext, setState) => AlertDialog(
          ...
          ), // the checkbox introduces a stubborn padding on its own, so we are lowering the surrounding padding and bumping up each individual child's horizontal padding values
