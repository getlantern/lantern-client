...
class DefaultAssetPickerBuilderDelegate
                      ...
                      RepaintBoundary(
                        child: Column(
                          children: <Widget>[
                            ...
                            // TODO(kallirroi): Remove landing page preview footer
  ...
  Widget confirmButton(BuildContext context) {
    return Consumer<DefaultAssetPickerProvider>(
      builder: (_, DefaultAssetPickerProvider provider, __) {
        // TODO(kallirroi): Share/confirm button in landing page
        if (provider.isSelectedNotEmpty) {
          return MaterialButton(
            minWidth: provider.isSelectedNotEmpty ? 48.0 : 20.0,
            height: appBarItemHeight,
            padding: const EdgeInsets.symmetric(horizontal: 12.0),
            // TODO(kallirroi): Generalize in theme
            color: Colors.white,
        ...
        return IgnorePointer(
          ...
          child: GestureDetector(
            ...
            child: AnimatedOpacity(
              ...
              // TODO(kallirroi): generalize bg color for path picker
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              borderRadius: isAppleOS
                  ...
                  : null,
              // TODO(kallirroi): background for path selector
  ...
  // TODO(kallirroi): Path selection widget
  @override
  Widget pathEntityWidget({
    required BuildContext context,
    ...
    Widget builder() {
      ...
      if (data != null) {
        ...
        // TODO(kallirroi): Color and icon for paths that doesn't have a preview thumbnail
        return ColoredBox(
          color: theme.primaryColor,
              ...
              Selector<DefaultAssetPickerProvider, AssetPathEntity?>(
                ...
                builder: (_, AssetPathEntity? currentPathEntity, __) {
                  if (currentPathEntity != pathEntity) {
                    ...
                    // TODO(kallirroi): path selector checkbox
                    return AspectRatio(
                      aspectRatio: 1.0,
                      child: Icon(Icons.check,
                          color: theme.primaryColorLight, size: 26.0),
                    );
                  }
                },
              ),
  ...
  Widget selectIndicator(BuildContext context, AssetEntity asset) {
    return Selector<DefaultAssetPickerProvider, String>(
      ...
      builder: (BuildContext context, _, __) {
        ...
        final indicatorSize = Screens.width / gridCount / 3;
        return Positioned(
          top: 0.0,
          right: 0.0,
          child: GestureDetector(
        ...
        child: Selector<DefaultAssetPickerProvider, List<AssetEntity>>(
          ...
          builder: (_, List<AssetEntity> selectedAssets, __) {
            ...
            return AnimatedContainer(
              duration: switchingPathDuration,
              // TODO(kallirroi): overlay when an item is selected
              color: selected
