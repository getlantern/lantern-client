...
abstract class AssetPickerViewerBuilderDelegate<A, P> {
  ...
  // TODO(kallirroi): custom styles, move to another file or connect to theme
  final _thumbnailViewerBackgroundColor = Colors.black;
  final _controlFooterBackgroundColor = Colors.black;
  final _dividerColor = Colors.white;
  final _checkboxBgColor = Color(0xcafefeed);
...
class DefaultAssetPickerViewerBuilderDelegate
  ...
  @override
  Widget assetPageBuilder(BuildContext context, int index) {
    final asset = previewAssets.elementAt(index);
    Widget builder;
    switch (asset.type) {
            ...
            children: <Widget>[
              ValueListenableBuilder<int>(
                ...
                builder: (_, int count, __) => Container(
                  ...
                  height: 90,
                  color: _thumbnailViewerBackgroundColor,
              ...
              // TODO(kallirroi): controls footer when viewing a media file
              Container(
                height: 50,
                ...
                decoration: BoxDecoration(
                  ...
                  color: _controlFooterBackgroundColor,
                ),
                child: Row(
      ...
      child: AspectRatio(
        ...
        child: StreamBuilder<int>(
          ...
          builder: (_, AsyncSnapshot<int> snapshot) {
            ...
            final isViewing = previewAssets[snapshot.data!] == asset;
            final _item = () {
              switch (asset.type) {
                case AssetType.image:
    ...
    return ChangeNotifierProvider<
      ...
      child: Consumer<AssetPickerViewerProvider<AssetEntity>?>(
        builder: (_, AssetPickerViewerProvider<AssetEntity>? provider, __) {
          ...
          return Container();
          // TODO(kallirroi): Hide image viewer button altogether
          ...
          //       }
          //       // TODO(kallirroi): remove count from Confirm button
