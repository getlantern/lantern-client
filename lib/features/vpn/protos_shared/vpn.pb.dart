...
class Bandwidth extends $pb.GeneratedMessage {
  ...
  Bandwidth._() : super();
  factory Bandwidth.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Bandwidth.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Bandwidth',
      createEmptyInstance: create)
    ..aInt64(1, _omitFieldNames ? '' : 'percent')
    ..aInt64(2, _omitFieldNames ? '' : 'dataUsageBytes',
        protoName: 'dataUsageBytes')
    ..aInt64(3, _omitFieldNames ? '' : 'dataAllowedBytes',
        protoName: 'dataAllowedBytes')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Bandwidth copyWith(void Function(Bandwidth) updates) =>
      super.copyWith((message) => updates(message as Bandwidth)) as Bandwidth;
  ...
  @$core.pragma('dart2js:noInline')
  static Bandwidth getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Bandwidth>(create);
  static Bandwidth? _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get percent => $_getI64(0);
  @$pb.TagNumber(1)
  set percent($fixnum.Int64 v) {
    $_setInt64(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set dataUsageBytes($fixnum.Int64 v) {
    $_setInt64(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set dataAllowedBytes($fixnum.Int64 v) {
    $_setInt64(2, v);
  }
...
class AppData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AppData',
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'packageName', protoName: 'packageName')
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..a<$core.List<$core.int>>(
        3, _omitFieldNames ? '' : 'icon', $pb.PbFieldType.OY)
  ...
  AppData copyWith(void Function(AppData) updates) =>
      super.copyWith((message) => updates(message as AppData)) as AppData;
...
class AppsData extends $pb.GeneratedMessage {
  ...
  AppsData._() : super();
  factory AppsData.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AppsData.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AppsData',
      createEmptyInstance: create)
    ..pc<AppData>(1, _omitFieldNames ? '' : 'appsList', $pb.PbFieldType.PM,
        protoName: 'appsList', subBuilder: AppData.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  AppsData copyWith(void Function(AppsData) updates) =>
      super.copyWith((message) => updates(message as AppsData)) as AppsData;
  ...
  @$core.pragma('dart2js:noInline')
  static AppsData getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AppsData>(create);
...
class Plans extends $pb.GeneratedMessage {
  ...
  Plans._() : super();
  factory Plans.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Plans.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Plans',
      createEmptyInstance: create)
    ..pc<Plan>(1, _omitFieldNames ? '' : 'plan', $pb.PbFieldType.PM,
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Plans copyWith(void Function(Plans) updates) =>
      super.copyWith((message) => updates(message as Plans)) as Plans;
  ...
  @$core.pragma('dart2js:noInline')
  static Plans getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Plans>(create);
...
class Plan extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $fixnum.Int64>(5, _omitFieldNames ? '' : 'price',
        entryClassName: 'Plan.PriceEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.O6)
    ..m<$core.String, $fixnum.Int64>(
        6, _omitFieldNames ? '' : 'expectedMonthlyPrice',
        protoName: 'expectedMonthlyPrice',
        entryClassName: 'Plan.ExpectedMonthlyPriceEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.O6)
    ..aOS(7, _omitFieldNames ? '' : 'totalCostBilledOneTime',
        protoName: 'totalCostBilledOneTime')
    ..aOS(8, _omitFieldNames ? '' : 'oneMonthCost', protoName: 'oneMonthCost')
    ..aOS(9, _omitFieldNames ? '' : 'totalCost', protoName: 'totalCost')
    ..aOS(10, _omitFieldNames ? '' : 'formattedBonus',
        protoName: 'formattedBonus')
    ..aOS(11, _omitFieldNames ? '' : 'renewalText', protoName: 'renewalText')
    ..m<$core.String, $fixnum.Int64>(
        13, _omitFieldNames ? '' : 'renewalBonusExpected',
        protoName: 'renewalBonusExpected',
        entryClassName: 'Plan.RenewalBonusExpectedEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.O6)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(6)
  $core.Map<$core.String, $fixnum.Int64> get expectedMonthlyPrice =>
      $_getMap(5);

  @$pb.TagNumber(7)
  $core.String get totalCostBilledOneTime => $_getSZ(6);
  @$pb.TagNumber(7)
  set totalCostBilledOneTime($core.String v) {
    $_setString(6, v);
  }
  ...
  @$pb.TagNumber(8)
  set oneMonthCost($core.String v) {
    $_setString(7, v);
  }
  ...
  @$pb.TagNumber(10)
  set formattedBonus($core.String v) {
    $_setString(9, v);
  }
  ...
  @$pb.TagNumber(13)
  $core.Map<$core.String, $fixnum.Int64> get renewalBonusExpected =>
      $_getMap(11);
}
...
class PaymentProviders extends $pb.GeneratedMessage {
  ...
  factory PaymentProviders.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PaymentProviders.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PaymentProviders',
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..pPS(3, _omitFieldNames ? '' : 'logoUrls', protoName: 'logoUrls')
    ..m<$core.String, $core.String>(4, _omitFieldNames ? '' : 'data',
        entryClassName: 'PaymentProviders.DataEntry',
        keyFieldType: $pb.PbFieldType.OS,
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PaymentProviders copyWith(void Function(PaymentProviders) updates) =>
      super.copyWith((message) => updates(message as PaymentProviders))
          as PaymentProviders;
  ...
  static $pb.PbList<PaymentProviders> createRepeated() =>
      $pb.PbList<PaymentProviders>();
  @$core.pragma('dart2js:noInline')
  static PaymentProviders getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PaymentProviders>(create);
...
class PaymentMethod extends $pb.GeneratedMessage {
  ...
  factory PaymentMethod.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PaymentMethod.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<PaymentProviders>(
        2, _omitFieldNames ? '' : 'providers', $pb.PbFieldType.PM,
        subBuilder: PaymentProviders.create)
    ..hasRequiredFields = false;
...
class User extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<Device>(8, _omitFieldNames ? '' : 'devices', $pb.PbFieldType.PM,
        subBuilder: Device.create)
    ...
    ..pc<Purchase>(16, _omitFieldNames ? '' : 'purchases', $pb.PbFieldType.PM,
        subBuilder: Purchase.create)
    ..hasRequiredFields = false;
...
class Purchase extends $pb.GeneratedMessage {
  ...
  Purchase._() : super();
  factory Purchase.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Purchase.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
...
class BaseResponse extends $pb.GeneratedMessage {
  ...
  factory BaseResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BaseResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
...
class PaymentRedirectRequest extends $pb.GeneratedMessage {
  ...
  factory PaymentRedirectRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PaymentRedirectRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PaymentRedirectRequest',
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'plan')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  PaymentRedirectRequest clone() =>
      PaymentRedirectRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PaymentRedirectRequest copyWith(
          void Function(PaymentRedirectRequest) updates) =>
      super.copyWith((message) => updates(message as PaymentRedirectRequest))
          as PaymentRedirectRequest;
  ...
  static $pb.PbList<PaymentRedirectRequest> createRepeated() =>
      $pb.PbList<PaymentRedirectRequest>();
  @$core.pragma('dart2js:noInline')
  static PaymentRedirectRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PaymentRedirectRequest>(create);
...
class RedeemResellerCodeRequest extends $pb.GeneratedMessage {
  ...
  factory RedeemResellerCodeRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RedeemResellerCodeRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RedeemResellerCodeRequest',
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  RedeemResellerCodeRequest clone() =>
      RedeemResellerCodeRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RedeemResellerCodeRequest copyWith(
          void Function(RedeemResellerCodeRequest) updates) =>
      super.copyWith((message) => updates(message as RedeemResellerCodeRequest))
          as RedeemResellerCodeRequest;
  ...
  static $pb.PbList<RedeemResellerCodeRequest> createRepeated() =>
      $pb.PbList<RedeemResellerCodeRequest>();
  @$core.pragma('dart2js:noInline')
  static RedeemResellerCodeRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RedeemResellerCodeRequest>(create);
  ...
  @$pb.TagNumber(2)
  set resellerCode($core.String v) {
    $_setString(1, v);
  }
...
class PaymentRedirectResponse extends $pb.GeneratedMessage {
  ...
  factory PaymentRedirectResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PaymentRedirectResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PaymentRedirectResponse',
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'status')
    ..aOS(2, _omitFieldNames ? '' : 'error')
    ..aOS(3, _omitFieldNames ? '' : 'errorId', protoName: 'errorId')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  PaymentRedirectResponse clone() =>
      PaymentRedirectResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PaymentRedirectResponse copyWith(
          void Function(PaymentRedirectResponse) updates) =>
      super.copyWith((message) => updates(message as PaymentRedirectResponse))
          as PaymentRedirectResponse;
  ...
  static $pb.PbList<PaymentRedirectResponse> createRepeated() =>
      $pb.PbList<PaymentRedirectResponse>();
  @$core.pragma('dart2js:noInline')
  static PaymentRedirectResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PaymentRedirectResponse>(create);
...
class LinkResponse extends $pb.GeneratedMessage {
  ...
  factory LinkResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory LinkResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
