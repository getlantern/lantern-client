...
void doContactAddingDance(
    BuildContext context, MessagingModel model, String id) async {
  var mostRecentHelloTs = await model.addProvisionalContact(id);
  var contactNotifier = model.contactNotifier(id);
