    ...
    return BaseScreen(
        ...
        body: Column(
            ...
            children: [
              ...
              Expanded(child: messagingModel.bestIntroductions(builder:
                  (bestIntrosContext,
                                                              ...
                                                              TextButton(
                                                                onPressed:
                                                                  ...
                                                                  try {
                                                                    ...
                                                                    await messagingModel.acceptIntroduction(
                                                                        introductor
                                                                            .contactId
                                                                            .id,
                                                                        value
                                                                    ...
                                                                    showSnackbar(
                                                                        ...
                                                                        action:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            await context.router.push(Conversation(contactId: value.introduction.to));
                                                                          },
                                                                        ));
                                                                  }
                                                                },
