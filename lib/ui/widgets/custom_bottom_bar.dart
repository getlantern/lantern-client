...
//   BottomNavigationBarItem renderBottomTabItem(
...
//       icon: tab.title == 'Account'
//           ? sessionModel.shouldShowYinbiBadge(
//               (BuildContext context, bool shouldShowYinbiBadge,
//                       Widget? child) =>
...
//               path: tab.icon,
//               size: 24,
//               color: selected ? selectedTabLabelColor : unselectedTabLabelColor,
//             ),
//     );
...
//     return vpnModel.vpnStatus(
//       (context, value, child) => BottomNavigationBar(
//         items: tabs
//             .map(
//               (e) => renderBottomTabItem(
//                   tab: e,
//                   isActive: (value == 'connected' || value == 'disconnecting'),
//                   context: context),
//             )
//             .toList(),
//       ),
