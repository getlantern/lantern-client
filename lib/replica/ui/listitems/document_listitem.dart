...
class ReplicaDocumentListItem extends ReplicaCommonListItem {
  ...
  @override
  State<StatefulWidget> createState() => _ReplicaDocumentListItem(item);
}

class _ReplicaDocumentListItem extends ReplicaCommonListItemState {
  final ReplicaSearchItem item;
  _ReplicaDocumentListItem(this.item);
