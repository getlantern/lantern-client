...
class ReplicaDocumentItem extends ReplicaSearchItem {
  ReplicaDocumentItem(
      String displayName,
  ...
  static List<ReplicaDocumentItem> fromJson(Map<String, dynamic> body) {
    var items = <ReplicaDocumentItem>[];
    ...
    for (var result in results) {
      try {
        ...
        items.add(ReplicaDocumentItem(displayName, primaryMimeType,
