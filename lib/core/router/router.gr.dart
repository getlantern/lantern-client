...
import 'package:lantern/account/blocked_users.dart' as _i8;
import 'package:lantern/account/chat_number_account.dart' as _i9;
import 'package:lantern/account/device_linking/approve_device.dart' as _i4;
...
import 'package:lantern/account/device_linking/authorize_device_via_email_pin.dart'
    as _i7;
import 'package:lantern/account/device_linking/link_device.dart' as _i22;
import 'package:lantern/account/invite_friends.dart' as _i19;
import 'package:lantern/account/language.dart' as _i20;
import 'package:lantern/account/lantern_desktop.dart' as _i21;
...
import 'package:lantern/common/ui/full_screen_dialog.dart' as _i15;
import 'package:lantern/home.dart' as _i16;
import 'package:lantern/messaging/contacts/add_contact_number.dart' as _i3;
import 'package:lantern/messaging/contacts/contact_info.dart' as _i13;
import 'package:lantern/messaging/contacts/new_chat.dart' as _i23;
...
import 'package:lantern/plans/checkout.dart' as _i12;
import 'package:lantern/plans/plans.dart' as _i24;
import 'package:lantern/plans/play_checkout.dart' as _i25;
...
abstract class $AppRouter extends _i41.RootStackRouter {
  ...
  final Map<String, _i41.PageFactory> pagesMap = {
    ...
    ApproveDevice.name: (routeData) {
      ...
      return _i41.AutoRoutePage<void>(
        routeData: routeData,
        child: _i4.ApproveDevice(key: args.key),
      );
    },
    AuthorizePro.name: (routeData) {
      ...
      return _i41.AutoRoutePage<void>(
        routeData: routeData,
        child: _i5.AuthorizeDeviceForPro(key: args.key),
      );
    },
    AuthorizeDeviceEmail.name: (routeData) {
      ...
      return _i41.AutoRoutePage<void>(
        routeData: routeData,
        child: _i6.AuthorizeDeviceViaEmail(key: args.key),
      );
    },
    ...
    BlockedUsers.name: (routeData) {
      ...
      return _i41.AutoRoutePage<void>(
        routeData: routeData,
        child: _i8.BlockedUsers(key: args.key),
      );
    },
    ChatNumberAccount.name: (routeData) {
      return _i41.AutoRoutePage<void>(
        routeData: routeData,
        child: _i9.ChatNumberAccount(),
      );
    },
    ChatNumberMessaging.name: (routeData) {
      return _i41.AutoRoutePage<void>(
        routeData: routeData,
        child: _i10.ChatNumberMessaging(),
      );
    },
    ...
    ContactInfo.name: (routeData) {
      ...
      return _i41.AutoRoutePage<void>(
        routeData: routeData,
        child: _i13.ContactInfo(contact: args.contact),
      );
    },
    ...
    LanternDesktop.name: (routeData) {
      return _i41.AutoRoutePage<void>(
        routeData: routeData,
        child: const _i21.LanternDesktop(),
      );
    },
    LinkDevice.name: (routeData) {
      ...
      return _i41.AutoRoutePage<void>(
        routeData: routeData,
        child: _i22.LinkDevice(key: args.key),
      );
    },
...
/// generated route for
/// [_i7.AuthorizeDeviceViaEmailPin]
...
/// generated route for
/// [_i25.PlayCheckout]
class PlayCheckout extends _i41.PageRouteInfo<PlayCheckoutArgs> {
  PlayCheckout({
    required _i43.Plan plan,
    required bool isPro,
    _i43.Key? key,
  ...
  static const _i41.PageInfo<PlayCheckoutArgs> page =
      _i41.PageInfo<PlayCheckoutArgs>(name);
}
