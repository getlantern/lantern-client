...
import 'package:lantern/messaging/conversation.dart' as _i6;
...
import 'package:lantern/ui/widgets/account/messaging/display_name.dart' as _i19;
...
class AppRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    Conversation.name: (routeData) => _i1.CustomPage<void>(
        ...
        builder: (data) {
          ...
          return _i6.Conversation(args.contactId);
        },
        transitionsBuilder: _i1.TransitionsBuilders.fadeIn,
        durationInMilliseconds: 450,
        reverseDurationInMilliseconds: 450,
  ...
  List<_i1.RouteConfig> get routes => [
        ...
        _i1.RouteConfig(ImageVideoDetailPage.name,
...
class Conversation extends _i1.PageRouteInfo<ConversationArgs> {
  Conversation({required _i21.ContactId contactId})
      : super(name,
...
class DisplayName extends _i1.PageRouteInfo<DisplayNameArgs> {
  DisplayName({_i11.Key? key, required _i21.Contact me})
      : super(name,
