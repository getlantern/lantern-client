...
import 'package:lantern/replica/link_handler.dart' as _i24;
import 'package:lantern/replica/ui/viewers/audio.dart' as _i28;
import 'package:lantern/replica/ui/viewers/image.dart' as _i26;
import 'package:lantern/replica/ui/viewers/misc.dart' as _i25;
import 'package:lantern/replica/ui/viewers/video.dart' as _i27;
import 'package:lantern/replica/upload/description.dart' as _i22;
import 'package:lantern/replica/upload/review.dart' as _i23;
import 'package:lantern/replica/upload/title.dart' as _i21;
...
class AppRouter extends _i33.RootStackRouter {
  ...
  List<_i33.RouteConfig> get routes => [
        ...
        _i33.RouteConfig(ReplicaUploadTitle.name, path: 'replicaUploadTitle'),
        _i33.RouteConfig(ReplicaUploadDescription.name,
            path: 'replicaUploadDescription'),
        _i33.RouteConfig(ReplicaUploadReview.name, path: 'replicaUploadReview'),
        _i33.RouteConfig(ReplicaLinkHandler.name, path: 'replicaLinkHandler'),
        _i33.RouteConfig(ReplicaMiscViewer.name, path: 'replicaMiscViewer'),
        _i33.RouteConfig(ReplicaImageViewer.name, path: 'replicaImageViewer'),
        _i33.RouteConfig(ReplicaVideoViewer.name, path: 'replicaVideoViewer'),
        _i33.RouteConfig(ReplicaAudioViewer.name, path: 'replicaAudioViewer'),
