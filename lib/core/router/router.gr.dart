...
import 'package:lantern/account/developer_settings.dart' as _i27;
...
import 'package:lantern/account/secure_chat_number_account.dart' as _i26;
...
import 'package:lantern/messaging/chats.dart' as _i12;
...
import 'package:lantern/messaging/onboarding_handler.dart' as _i11;
...
class AppRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    DeveloperRoute.name: (routeData) => _i1.CustomPage<void>(
        ...
        opaque: true,
        barrierDismissible: false),
    OnboardingHandlerRoute.name: (routeData) => _i1.CustomPage<void>(
        routeData: routeData,
        builder: (_) {
          return _i11.OnboardingHandler();
        },
        transitionsBuilder: _i1.TransitionsBuilders.fadeIn,
        durationInMilliseconds: 200,
        reverseDurationInMilliseconds: 200,
        opaque: true,
        barrierDismissible: false),
    Chats.name: (routeData) => _i1.CustomPage<void>(
        routeData: routeData,
        builder: (_) {
          return _i12.Chats();
        },
        ...
        opaque: true,
        barrierDismissible: false),
    Welcome.name: (routeData) => _i1.CustomPage<void>(
        routeData: routeData,
        builder: (_) {
          return _i13.Welcome();
        },
        ...
        opaque: true,
        barrierDismissible: false),
    SecureChatNumberMessaging.name: (routeData) => _i1.CustomPage<void>(
        routeData: routeData,
        builder: (_) {
          return _i14.SecureChatNumberMessaging();
        },
        transitionsBuilder: _i1.TransitionsBuilders.fadeIn,
        durationInMilliseconds: 200,
        reverseDurationInMilliseconds: 200,
    ...
    SecureNumberRecovery.name: (routeData) => _i1.CustomPage<void>(
        routeData: routeData,
        builder: (_) {
          return _i15.SecureNumberRecovery();
        },
        transitionsBuilder: _i1.TransitionsBuilders.fadeIn,
        durationInMilliseconds: 200,
        reverseDurationInMilliseconds: 200,
    ...
    RecoveryKey.name: (routeData) => _i1.CustomPage<void>(
        ...
        builder: (data) {
          ...
          return _i25.RecoveryKey(key: args.key);
        },
        transitionsBuilder: _i1.TransitionsBuilders.fadeIn,
        durationInMilliseconds: 200,
        reverseDurationInMilliseconds: 200,
        opaque: true,
        barrierDismissible: false),
    SecureChatNumberAccount.name: (routeData) => _i1.CustomPage<void>(
        routeData: routeData,
        builder: (_) {
          return _i26.SecureChatNumberAccount();
        },
        transitionsBuilder: _i1.TransitionsBuilders.fadeIn,
        durationInMilliseconds: 200,
        reverseDurationInMilliseconds: 200,
    ...
    DeveloperSettings.name: (routeData) => _i1.CustomPage<void>(
        ...
        builder: (data) {
          ...
          return _i27.DeveloperSettingsTab(key: args.key);
        },
        transitionsBuilder: _i1.TransitionsBuilders.fadeIn,
        durationInMilliseconds: 200,
        reverseDurationInMilliseconds: 200,
  ...
  List<_i1.RouteConfig> get routes => [
        _i1.RouteConfig(Home.name, path: '/', children: [
          _i1.RouteConfig(MessagesRouter.name, path: 'messages', children: [
            _i1.RouteConfig(OnboardingHandlerRoute.name, path: ''),
            _i1.RouteConfig(Chats.name, path: 'chats'),
            _i1.RouteConfig(Welcome.name, path: 'welcome'),
            _i1.RouteConfig(SecureChatNumberMessaging.name,
                path: 'secureChatNumberMessaging'),
            _i1.RouteConfig(SecureNumberRecovery.name,
          ...
          _i1.RouteConfig(AccountRouter.name, path: 'account', children: [
            ...
            _i1.RouteConfig(SecureChatNumberAccount.name,
...
class Home extends _i1.PageRouteInfo<HomeArgs> {
  Home({_i28.Key? key, List<_i1.PageRouteInfo>? children})
      : super(name,
...
class OnboardingHandlerRoute extends _i1.PageRouteInfo {
  const OnboardingHandlerRoute() : super(name, path: '');

  static const String name = 'OnboardingHandlerRoute';
}

class Chats extends _i1.PageRouteInfo {
...
class SecureChatNumberMessaging extends _i1.PageRouteInfo {
...
class SecureChatNumberAccount extends _i1.PageRouteInfo {
