...
import 'package:lantern/replica/logic/api.dart' as _i34;
import 'package:lantern/replica/models/replica_link.dart' as _i35;
import 'package:lantern/replica/models/searchcategory.dart' as _i36;
...
class AppRouter extends _i31.RootStackRouter {
  ...
  final Map<String, _i31.PageFactory> pagesMap = {
    ...
    Checkout.name: (routeData) {
      ...
      return _i31.CustomPage<void>(
          routeData: routeData,
          child: _i30.Checkout(key: args.key),
          transitionsBuilder: _i31.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 200,
          reverseDurationInMilliseconds: 200,
          opaque: true,
  ...
  List<_i31.RouteConfig> get routes => [
        ...
        _i31.RouteConfig(ReplicaLinkOpenerScreen.name,
        ...
        _i31.RouteConfig(ReplicaUploadFileScreen.name,
            path: 'replicaUploadFileScreen'),
        _i31.RouteConfig(Upgrade.name, path: 'upgrade'),
        _i31.RouteConfig(Checkout.name, path: 'checkout')
      ];
}
...
class ReplicaLinkOpenerScreen
    extends _i31.PageRouteInfo<ReplicaLinkOpenerScreenArgs> {
...
class ReplicaUploadFileScreen
    extends _i31.PageRouteInfo<ReplicaUploadFileScreenArgs> {
  ReplicaUploadFileScreen({_i33.Key? key, required _i33.File fileToUpload})
...
/// generated route for
/// [_i29.Upgrade]
class Upgrade extends _i31.PageRouteInfo<UpgradeArgs> {
  Upgrade({_i33.Key? key})
...
/// generated route for
/// [_i30.Checkout]
class Checkout extends _i31.PageRouteInfo<CheckoutArgs> {
  Checkout({_i33.Key? key})
      : super(Checkout.name, path: 'checkout', args: CheckoutArgs(key: key));
