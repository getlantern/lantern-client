...
import 'package:lantern/account/account_management.dart' as _i19;
import 'package:lantern/account/account_tab.dart' as _i18;
import 'package:lantern/account/blocked_users.dart' as _i11;
import 'package:lantern/account/developer_settings.dart' as _i26;
import 'package:lantern/account/device_linking/approve_device.dart' as _i25;
...
import 'package:lantern/account/settings.dart' as _i20;
import 'package:lantern/common/ui/full_screen_dialog.dart' as _i2;
import 'package:lantern/home.dart' as _i1;
import 'package:lantern/messaging/chats.dart' as _i16;
...
import 'package:lantern/messaging/onboarding/secure_chat_number_recovery.dart'
    as _i14;
import 'package:lantern/messaging/onboarding/welcome.dart' as _i13;
import 'package:lantern/vpn/vpn_tab.dart' as _i17;
...
class AppRouter extends _i12.RootStackRouter {
  ...
  final Map<String, _i12.PageFactory> pagesMap = {
    ...
    BlockedUsers.name: (routeData) {
      ...
      return _i12.CustomPage<void>(
          routeData: routeData,
          child: _i11.BlockedUsers(key: args.key),
          transitionsBuilder: _i12.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 200,
          reverseDurationInMilliseconds: 200,
          opaque: true,
    ...
    SecureNumberRecovery.name: (routeData) {
      return _i12.CustomPage<void>(
          routeData: routeData,
          child: _i14.SecureNumberRecovery(),
          transitionsBuilder: _i12.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 200,
          reverseDurationInMilliseconds: 200,
          opaque: true,
    ...
    SecureChatNumberMessaging.name: (routeData) {
      return _i12.CustomPage<void>(
          routeData: routeData,
          child: _i15.SecureChatNumberMessaging(),
          transitionsBuilder: _i12.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 200,
          reverseDurationInMilliseconds: 200,
          opaque: true,
    ...
    Vpn.name: (routeData) {
      ...
      return _i12.CustomPage<void>(
          routeData: routeData,
          child: _i17.VPNTab(key: args.key),
          transitionsBuilder: _i12.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 200,
          reverseDurationInMilliseconds: 200,
          opaque: true,
    ...
    AccountManagement.name: (routeData) {
      ...
      return _i12.CustomPage<void>(
          routeData: routeData,
          child: _i19.AccountManagement(key: args.key, isPro: args.isPro),
          transitionsBuilder: _i12.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 200,
          reverseDurationInMilliseconds: 200,
          opaque: true,
    ...
    Settings.name: (routeData) {
      ...
      return _i12.CustomPage<void>(
          routeData: routeData,
          child: _i20.Settings(key: args.key),
          transitionsBuilder: _i12.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 200,
          reverseDurationInMilliseconds: 200,
          opaque: true,
    ...
    AuthorizeDeviceEmail.name: (routeData) {
      ...
      return _i12.CustomPage<void>(
          routeData: routeData,
          child: _i23.AuthorizeDeviceViaEmail(key: args.key),
          transitionsBuilder: _i12.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 200,
          reverseDurationInMilliseconds: 200,
          opaque: true,
    ...
    AuthorizeDeviceEmailPin.name: (routeData) {
      ...
      return _i12.CustomPage<void>(
          routeData: routeData,
          child: _i24.AuthorizeDeviceViaEmailPin(key: args.key),
          transitionsBuilder: _i12.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 200,
          reverseDurationInMilliseconds: 200,
          opaque: true,
    ...
    ApproveDevice.name: (routeData) {
      ...
      return _i12.CustomPage<void>(
          routeData: routeData,
          child: _i25.ApproveDevice(key: args.key),
          transitionsBuilder: _i12.TransitionsBuilders.fadeIn,
          durationInMilliseconds: 200,
          reverseDurationInMilliseconds: 200,
          opaque: true,
  ...
  List<_i12.RouteConfig> get routes => [
        _i12.RouteConfig(Home.name, path: '/', children: [
          _i12.RouteConfig(OnboardingRouter.name,
              path: 'onboarding',
              parent: Home.name,
              children: [
                _i12.RouteConfig('#redirect',
                    ...
                    redirectTo: 'welcome',
                    fullMatch: true),
                _i12.RouteConfig(Welcome.name,
                    path: 'welcome', parent: OnboardingRouter.name),
                _i12.RouteConfig(SecureNumberRecovery.name,
                    path: 'secureNumberRecovery',
                    parent: OnboardingRouter.name),
                _i12.RouteConfig(SecureChatNumberMessaging.name,
          ...
          _i12.RouteConfig(MessagesRouter.name,
              ...
              parent: Home.name,
              children: [
                _i12.RouteConfig(ChatsRoute.name,
                    path: '', parent: MessagesRouter.name)
              ]),
          _i12.RouteConfig(VpnRouter.name,
              path: 'vpn',
              parent: Home.name,
              children: [
                _i12.RouteConfig(Vpn.name, path: '', parent: VpnRouter.name)
              ]),
          _i12.RouteConfig(AccountRouter.name,
              path: 'account',
              parent: Home.name,
              children: [
                _i12.RouteConfig(Account.name,
                    path: '', parent: AccountRouter.name),
                _i12.RouteConfig(AccountManagement.name,
                    path: 'accountManagement', parent: AccountRouter.name),
                _i12.RouteConfig(Settings.name,
                    path: 'settings', parent: AccountRouter.name),
                _i12.RouteConfig(Language.name,
                    path: 'language', parent: AccountRouter.name),
                _i12.RouteConfig(AuthorizePro.name,
                    path: 'authorizePro', parent: AccountRouter.name),
                _i12.RouteConfig(AuthorizeDeviceEmail.name,
                    path: 'authorizeDeviceEmail', parent: AccountRouter.name),
                _i12.RouteConfig(AuthorizeDeviceEmailPin.name,
                    path: 'authorizeDeviceEmailPin',
                    parent: AccountRouter.name),
                _i12.RouteConfig(ApproveDevice.name,
                    path: 'approveDevice', parent: AccountRouter.name)
              ]),
          _i12.RouteConfig(DeveloperRoute.name,
              path: 'developer',
              parent: Home.name,
              children: [
                _i12.RouteConfig(DeveloperSettings.name,
                    path: '', parent: DeveloperRoute.name)
              ])
        ]),
        _i12.RouteConfig(FullScreenDialogPage.name,
            path: 'fullScreenDialogPage'),
        _i12.RouteConfig(Conversation.name, path: 'conversation'),
        _i12.RouteConfig(ContactInfo.name, path: 'contactInfo'),
        _i12.RouteConfig(NewChat.name, path: 'newChat'),
        _i12.RouteConfig(AddViaChatNumber.name, path: 'addViaChatNumber'),
        _i12.RouteConfig(Introduce.name, path: 'introduce'),
        _i12.RouteConfig(Introductions.name, path: 'introductions'),
        _i12.RouteConfig(RecoveryKey.name, path: 'recoveryKey'),
        _i12.RouteConfig(SecureChatNumberAccount.name,
            path: 'secureChatNumberAccount'),
        _i12.RouteConfig(BlockedUsers.name, path: 'blockedUsers')
      ];
}

/// generated route for [_i1.HomePage]
class Home extends _i12.PageRouteInfo<HomeArgs> {
  Home({_i28.Key? key, List<_i12.PageRouteInfo>? children})
      : super(name,
...
class FullScreenDialogPage
    extends _i12.PageRouteInfo<FullScreenDialogPageArgs> {
...
class Conversation extends _i12.PageRouteInfo<ConversationArgs> {
  Conversation(
...
class ContactInfo extends _i12.PageRouteInfo<ContactInfoArgs> {
  ContactInfo(
...
class NewChat extends _i12.PageRouteInfo<void> {
...
class AddViaChatNumber extends _i12.PageRouteInfo<void> {
...
class Introductions extends _i12.PageRouteInfo<void> {
...
class RecoveryKey extends _i12.PageRouteInfo<RecoveryKeyArgs> {
...
class SecureChatNumberAccount extends _i12.PageRouteInfo<void> {
...
/// generated route for [_i11.BlockedUsers]
class BlockedUsers extends _i12.PageRouteInfo<BlockedUsersArgs> {
...
class OnboardingRouter extends _i12.PageRouteInfo<void> {
  const OnboardingRouter({List<_i12.PageRouteInfo>? children})
...
/// generated route for [_i12.EmptyRouterPage]
class VpnRouter extends _i12.PageRouteInfo<void> {
  const VpnRouter({List<_i12.PageRouteInfo>? children})
...
/// generated route for [_i12.EmptyRouterPage]
class DeveloperRoute extends _i12.PageRouteInfo<void> {
  const DeveloperRoute({List<_i12.PageRouteInfo>? children})
      : super(name, path: 'developer', initialChildren: children);

  static const String name = 'DeveloperRoute';
}

/// generated route for [_i13.Welcome]
...
/// generated route for [_i14.SecureNumberRecovery]
class SecureNumberRecovery extends _i12.PageRouteInfo<void> {
  const SecureNumberRecovery() : super(name, path: 'secureNumberRecovery');

  static const String name = 'SecureNumberRecovery';
}

/// generated route for [_i15.SecureChatNumberMessaging]
class SecureChatNumberMessaging extends _i12.PageRouteInfo<void> {
...
/// generated route for [_i17.VPNTab]
class Vpn extends _i12.PageRouteInfo<VpnArgs> {
...
/// generated route for [_i18.AccountTab]
...
/// generated route for [_i19.AccountManagement]
class AccountManagement extends _i12.PageRouteInfo<AccountManagementArgs> {
...
/// generated route for [_i20.Settings]
class Settings extends _i12.PageRouteInfo<SettingsArgs> {
...
/// generated route for [_i21.Language]
class Language extends _i12.PageRouteInfo<LanguageArgs> {
...
/// generated route for [_i22.AuthorizeDeviceForPro]
class AuthorizePro extends _i12.PageRouteInfo<AuthorizeProArgs> {
...
/// generated route for [_i23.AuthorizeDeviceViaEmail]
class AuthorizeDeviceEmail
    extends _i12.PageRouteInfo<AuthorizeDeviceEmailArgs> {
...
/// generated route for [_i24.AuthorizeDeviceViaEmailPin]
class AuthorizeDeviceEmailPin
    extends _i12.PageRouteInfo<AuthorizeDeviceEmailPinArgs> {
...
/// generated route for [_i25.ApproveDevice]
class ApproveDevice extends _i12.PageRouteInfo<ApproveDeviceArgs> {
...
class DeveloperSettings extends _i12.PageRouteInfo<DeveloperSettingsArgs> {
