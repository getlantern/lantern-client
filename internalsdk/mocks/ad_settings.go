...
func (_m *AdSettings) GetAdProvider(isPro bool, countryCode string, daysSinceInstalled int) (AdProvider, error) {
	...
	var r0 AdProvider
	var r1 error
	if rf, ok := ret.Get(0).(func(bool, string, int) (AdProvider, error)); ok {
		return rf(isPro, countryCode, daysSinceInstalled)
	}
	if rf, ok := ret.Get(0).(func(bool, string, int) AdProvider); ok {
		r0 = rf(isPro, countryCode, daysSinceInstalled)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(AdProvider)
		}
	}
