...
import org.lantern.app.service.BackgroundChecker_;
import org.lantern.app.activity.WelcomeActivity_;
import org.lantern.app.activity.yinbi.YinbiWelcomeActivity_;
...
public class PaymentHandler {
    ...
    public void checkProUser(final boolean asBroadcast) {
        ...
        if (session.yinbiEnabled()) {
            checkerIntent.putExtra("nextActivity", "org.lantern.app.activity.yinbi.YinbiWelcomeActivity_");
        } else {
            checkerIntent.putExtra("nextActivity", "org.lantern.app.activity.WelcomeActivity_");
        }
