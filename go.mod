...
require (
	...
	github.com/getlantern/pathdb v0.0.0-20230926201708-bdd7fd68ad9e
...
require (
	...
	github.com/getlantern/http-proxy-lantern/v2 v2.8.3-0.20230823232826-e00843a1c66c // indirect
