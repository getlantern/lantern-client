...
replace github.com/google/netstack => github.com/getlantern/netstack v0.0.0-20240112060218-7321f17ab0dd
...
require (
	...
	github.com/getlantern/broflake v0.0.0-20240112052310-d2b5a978b90b // indirect
